...
class ThisSbusReceiver(ColObjects.ColObj):
    def __init__(self):
        ...
        self.spin_interpolator = ColObjects.Interpolator('Spin Interpolator',
                                                [100, 200, 950, 1050, 1750, 1900], [-100.0, -100.0, 0.0, 0.0, 100.0, 100.0])
        self.crab_interpolator = ColObjects.Interpolator('Crab Interpolator',
                                                [100, 200, 950, 1050, 1750, 1900], [100.0, 100.0, 0.0, 0.0, -100.0, -100.0])
        ...
        self.fore_and_aft = ColObjects.Joystick('Fore and Aft', self, 2, self.fore_and_aft_interpolator)
        self.crab = ColObjects.Joystick('Crab', self, 1, self.spin_interpolator)
